...
############################################
# We use a SAFE wildcard OIDC trust because every EKS cluster automatically 
# creates an OIDC provider like:
# arn:aws:iam::<account>:oidc-provider/oidc.eks.<region>.amazonaws.com/id/<random>
#
